...
// Firmware for the cartBot base with ultrasonic sensor
// full test is incomplete.
...
PID motor2_pid(PWM_MIN, PWM_MAX, K_P_m2, K_I_m2, K_D_m2);
...
UltrasonicSensor ultrasonic_sensor(ULTRASONIC_TRIGGER_PIN, ULTRASONIC_ECHO_PIN);
...
bool createEntities()
{
    ...
    // create Range publisher for ultrasonic sensor
    RCCHECK(rclc_publisher_init_default( 
        &range_publisher, 
        &node,
...
void publishData()
{
    ...
    range_msg = ultrasonic_sensor.getData();
