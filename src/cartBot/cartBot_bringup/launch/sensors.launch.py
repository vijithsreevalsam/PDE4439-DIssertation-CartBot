...
def generate_launch_description():
    laser_sensor_name = os.getenv('cartBot_LASER_SENSOR', '')
    depth_sensor_name = os.getenv('cartBot_DEPTH_SENSOR', '')
    
    fake_laser_config_path = PathJoinSubstitution(
        [FindPackageShare('cartBot_bringup'), 'config', 'fake_laser.yaml']
    )
    ...
    laser_launch_path = PathJoinSubstitution(
        [FindPackageShare('cartBot_bringup'), 'launch', 'lasers.launch.py']
    )
    # laser_launch_path = PathJoinSubstitution(
    ...
    depth_launch_path = PathJoinSubstitution(
        [FindPackageShare('cartBot_bringup'), 'launch', 'depth.launch.py']
    )
