...
// #define MAG_BIAS { -6.04725e-06, -3.53625e-06, 2.89358e-05 } //run magnetometer calibration . the git is https://github.com/mikeferguson/robot_calibration#the-magnetometer_calibration-node
// #define MAG_BIAS { 3.33894e-07, 1.34421e-05,  -1.18456e-06 }
...
#define MOTOR_MAX_RPM 200 //140                   // motor's max RPM          
#define MAX_RPM_RATIO 0.75 //0.40 //0.54 //0.85                  // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO          
#define MOTOR_OPERATING_VOLTAGE 8  //6 //24          // motor's operating voltage (used to calculate max RPM)
#define MOTOR_POWER_MAX_VOLTAGE 8 //12          // max voltage of the motor's power source (used to calculate max RPM)
#define MOTOR_POWER_MEASURED_VOLTAGE 8.15 //12     // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 1330 //1344 //1840 //1436 //1959  //144000              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 1418 //1435 //1984 //1995 //1881  //144000              // wheel2 encoder's no of ticks per rev
...
#define WHEEL_DIAMETER 0.066 //0.062 //0.152                // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.180 //0.185 //0.271            // distance between left and right wheels
